...
// EnterPlural_name is called when production plural_name is entered.
func (s *BaseYammmGrammarListener) EnterPlural_name(ctx *Plural_nameContext) {}

// ExitPlural_name is called when production plural_name is exited.
func (s *BaseYammmGrammarListener) ExitPlural_name(ctx *Plural_nameContext) {}
...
func (s *BaseYammmGrammarListener) EnterAlias(ctx *AliasContext) {}

// ExitAlias is called when production alias is exited.
func (s *BaseYammmGrammarListener) ExitAlias(ctx *AliasContext) {}
...
// EnterSpacevectorT is called when production spacevectorT is entered.
func (s *BaseYammmGrammarListener) EnterSpacevectorT(ctx *SpacevectorTContext) {}

// ExitSpacevectorT is called when production spacevectorT is exited.
func (s *BaseYammmGrammarListener) ExitSpacevectorT(ctx *SpacevectorTContext) {}
