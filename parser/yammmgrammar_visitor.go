...
type YammmGrammarVisitor interface {
	...
	// Visit a parse tree produced by YammmGrammarParser#plural_name.
	VisitPlural_name(ctx *Plural_nameContext) interface{}
	...
	// Visit a parse tree produced by YammmGrammarParser#alias.
	...
	// Visit a parse tree produced by YammmGrammarParser#spacevectorT.
	VisitSpacevectorT(ctx *SpacevectorTContext) interface{}
