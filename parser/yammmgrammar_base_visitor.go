...
func (v *BaseYammmGrammarVisitor) VisitPlural_name(ctx *Plural_nameContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseYammmGrammarVisitor) VisitAlias(ctx *AliasContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseYammmGrammarVisitor) VisitSpacevectorT(ctx *SpacevectorTContext) interface{} {
	return v.VisitChildren(ctx)
}
