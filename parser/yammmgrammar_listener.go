...
type YammmGrammarListener interface {
	...
	// EnterPlural_name is called when entering the plural_name production.
	EnterPlural_name(c *Plural_nameContext)
	...
	// EnterSpacevectorT is called when entering the spacevectorT production.
	EnterSpacevectorT(c *SpacevectorTContext)
	...
	// ExitPlural_name is called when exiting the plural_name production.
	ExitPlural_name(c *Plural_nameContext)
	...
	ExitSpacevectorT(c *SpacevectorTContext)
